...
async function UpdateUser(id_usuario, dados) {
    ...
    const {nome, email, endereco, complemento, bairro, cidade, uf, cep }= dados
    
            let sql= 'update usuario set nome = ?, email = ?, endereco= ?, complemento = ?, bairro = ?, cidade = ?, uf =  ?, cep = ? where id = ?';
